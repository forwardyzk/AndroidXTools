 ...
 * Description:主页工具
 */
public class ToolsAdapter extends BaseQuickAdapter<ClassFlagBean> {
    ...
    @Override
    protected void onBind(QuickViewHolder holder, ClassFlagBean item, int position) {
        if (item == null) {
            return;
        }
        holder.setText(R.id.item_main_tv, item.aClass.getSimpleName());
    }
