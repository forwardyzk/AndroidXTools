...
import com.yzk.xtools.base.adapter.entity.SpanSize;
import com.yzk.xtools.base.adapter.entity.ViewType;
...
import com.yzk.xtools.base.adapter.manager.AnimationManager;
import com.yzk.xtools.base.adapter.manager.EmptyManager;
import com.yzk.xtools.base.adapter.manager.FooterManager;
import com.yzk.xtools.base.adapter.manager.HeaderManager;
import com.yzk.xtools.base.adapter.manager.LoadMoreManager;
import com.yzk.xtools.base.adapter.manager.SpanSizeManager;
...
public abstract class BaseAdapter<T, VH extends RecyclerView.ViewHolder> extends RecyclerView.Adapter {
    ...
    public void changeData(int index, T item) {
        checkData();
    ...
    private VH createDataViewHolder(ViewGroup parent, int viewType) {
        ...
        //bind listener
        itemView.bindListener(this, holder);
    ...
    protected void onBind(VH holder, int position) {
    ...
    public void onViewAttachedToWindow(RecyclerView.ViewHolder holder) {
        ...
        if (holder.getItemViewType() == VIEW_TYPE_HEADER) {
            if (mHeaderManager != null) {
                mHeaderManager.onViewAttachedToWindow();
            }
        }
    }
    ...
    public void onViewDetachedFromWindow(@NonNull RecyclerView.ViewHolder holder) {
        ...
        if (holder.getItemViewType() == VIEW_TYPE_HEADER) {
            if (mHeaderManager != null) {
                mHeaderManager.onViewDetachedFromWindow();
            }
        }
    }
