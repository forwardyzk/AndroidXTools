...
public final class IOFileUtil {
    ...
    public static byte[] readFile2BytesByStream(File file) {
        ...
        try {
            ...
            int len;
            while ((len = fis.read(b, 0, MemoryConstant.KB)) != -1) {
                os.write(b, 0, len);
            }
