...
/**
 * Author:yang
 * Time:2019/4/19 10:33
 * Description:Cpu操作工具类
 */
public class CpuUtils {

    public static final String UTIL_DESC = "CpuUtils工具类";
    public static final String UTIL_NAME = CpuUtils.class.getSimpleName();
